...
export const dataEngineeringSkills: SkillConfig[] = [
  ...
  },
  {
    ...
    shortDescription: '',
    startDate: '2020-01',
    useCases: ['Line plots', 'Histograms', 'Scatter plots', 'Custom visualizations'],
    relatedTo: ['Seaborn', 'Pandas', 'NumPy', 'Python', 'Jupyter'],
  },
  {
    title: 'Seaborn',
    icon: LineChart,
    description: 'Statistical data visualization library built on Matplotlib. Seaborn provides a high-level interface for drawing attractive and informative statistical graphics with minimal code.',
    shortDescription: '',
    startDate: '2021-01',
    useCases: ['Statistical plots', 'Distribution plots', 'Heatmaps', 'Pair plots'],
    relatedTo: ['Matplotlib', 'Pandas', 'Python', 'Jupyter'],
  },
  {
    title: 'Jupyter',
    icon: FileCode,
    description: 'Interactive computing environment for data science and research. Jupyter notebooks combine code, visualizations, and narrative text in a single document for reproducible analysis and experimentation.',
    shortDescription: '',
    startDate: '2020-01',
    useCases: ['Interactive analysis', 'Data exploration', 'ML experiments', 'Documentation'],
    relatedTo: ['Python', 'Pandas', 'Matplotlib', 'Google Colab', 'NumPy'],
  },
  {
    title: 'Google Colab',
    icon: Cloud,
    description: 'Free cloud-based Jupyter notebook environment by Google. Colab provides free GPU/TPU access for machine learning, seamless Google Drive integration, and easy sharing of notebooks.',
    shortDescription: '',
    startDate: '2021-01',
  ...
  },
  {
    title: 'PyAgrum',
    icon: Brain,
    description: 'Python library for Bayesian networks and other probabilistic graphical models. PyAgrum enables building, learning, and reasoning with Bayesian networks for uncertainty quantification and decision support.',
    shortDescription: '',
    startDate: '2024-01',
  ...
  },
  {
    title: 'Anaconda',
    icon: Container,
    description: 'Distribution of Python and R for scientific computing and data science. Anaconda simplifies package management and deployment with conda, providing a complete environment for data analysis and ML.',
    shortDescription: '',
    startDate: '2020-01',
