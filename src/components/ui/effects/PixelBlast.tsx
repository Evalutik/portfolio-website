...
void main(){
  ...
  if (uEdgeFade > 0.0) {
    ...
    // Fade Left, Bottom, Top only. 
    // We intentionally removed (1.0 - norm.x) to keep the Right edge sharp.
    float edge = min(min(norm.x, norm.y), 1.0 - norm.y);
    float fade = smoothstep(0.0, uEdgeFade, edge);
    M *= fade;
  }

  // Apply inverse gamma correction for accurate sRGB color
